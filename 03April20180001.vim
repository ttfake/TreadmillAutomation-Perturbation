...
badd +1336 src/PerturbationTabWidget.cpp
...
badd +86 include/PerturbationTabWidget.h
badd +7 src/SmileyGone.qml
badd +17 src/MouseInterface.cpp
badd +25 src/SubjectInterface.qml_bkup
badd +177 src/ParseRunProfile.cpp
badd +459 src/TreadmillAutomationDbIFace.cpp
...
1762
normal! zo
let s:l = 1701 - ((35 * winheight(0) + 20) / 41)
