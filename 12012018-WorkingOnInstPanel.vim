...
set shortmess=aoO
badd +24 src/SubjectInterface.qml
badd +234 src/PerturbationTabWidget.cpp
badd +25 src/SubjectInterface.cpp
badd +41 build/cleanCmakeWindows.sh
badd +1 src/MainSubjectInterface.qml
...
badd +311 include/PerturbationTabWidget.h
badd +7 src/SmileyGone.qml
badd +237 src/MouseInterface.cpp
badd +25 src/SubjectInterface.qml_bkup
badd +141 src/ParseRunProfile.cpp
badd +260 src/TreadmillAutomationDbIFace.cpp
badd +5 include/TreadmillAutomationDbIFace.h
badd +7 src/PersonSessionStimData.qml
argglobal
silent! argdel *
...
let s:l = 234 - ((20 * winheight(0) + 20) / 41)
