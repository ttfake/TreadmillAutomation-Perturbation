...
badd +1078 src/PerturbationTabWidget.cpp
...
badd +315 include/PerturbationTabWidget.h
badd +7 src/SmileyGone.qml
badd +47 src/MouseInterface.cpp
...
badd +9 src/ConfigTabWidget.cpp
badd +172 src/Timer.qml
badd +1 include/ConfigTabWidget.h
...
let s:l = 286 - ((40 * winheight(0) + 20) / 41)
