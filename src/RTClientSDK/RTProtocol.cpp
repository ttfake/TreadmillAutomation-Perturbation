#include "../../include/RTClientSDK/RTProtocol.h"
#include "../../include/RTClientSDK/Markup.h"
    ...
    if (eVideoAspectRatio)
    {
        switch (*eVideoAspectRatio)
        {
            case VideoAspectRatio16x9:
                oXML.AddElem("Video_Aspect_Ratio", "16:9");
                break;
            case VideoAspectRatio4x3:
                oXML.AddElem("Video_Aspect_Ratio", "4:3");
                break;
            case VideoAspectRatio1x1:
                oXML.AddElem("Video_Aspect_Ratio", "1:1");
                break;
        }
    }
...
{
	std::cout << "Command String: " << pCmdStr << std::endl;
