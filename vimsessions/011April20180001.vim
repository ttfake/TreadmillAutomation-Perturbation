...
badd +577 src/PerturbationTabWidget.cpp
...
badd +27 src/ParseRunProfile.cpp
badd +19 src/TreadmillAutomationDbIFace.cpp
badd +58 include/TreadmillAutomationDbIFace.h
...
badd +43 include/ParseRunProfile.h
...
let s:l = 1074 - ((25 * winheight(0) + 20) / 41)
