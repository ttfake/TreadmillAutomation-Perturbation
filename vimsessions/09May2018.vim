...
badd +43 src/PerturbationTabWidget.cpp
...
badd +92 src/InstrumentationPanel.cpp
badd +45 include/InstrumentationPanel.h
badd +8 src/InstrumentationPanel.qml
badd +1 src/MainInstrumentationPanel.qml
badd +23 src/TreadmillAutomation.cpp
badd +4 include/PerturbationTabWidget.h
...
let s:l = 209 - ((0 * winheight(0) + 20) / 41)
