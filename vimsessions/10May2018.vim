...
badd +77 src/InstrumentationPanel.cpp
badd +50 include/InstrumentationPanel.h
badd +8 src/InstrumentationPanel.qml
badd +1 src/MainInstrumentationPanel.qml
badd +13 src/TreadmillAutomation.cpp
badd +331 include/PerturbationTabWidget.h
...
badd +15 src/DataSource.cpp
badd +26 include/DataSource.h
badd +1 src/main.qml
argglobal
silent! argdel *
$argadd src/SubjectInterface.qml
edit src/InstrumentationPanel.cpp
...
let s:l = 77 - ((20 * winheight(0) + 20) / 41)
