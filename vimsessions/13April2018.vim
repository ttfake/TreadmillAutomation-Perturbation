...
set shortmess=aoO
badd +29 src/SubjectInterface.qml
badd +979 src/PerturbationTabWidget.cpp
badd +58 src/SubjectInterface.cpp
badd +41 build/cleanCmakeWindows.sh
badd +21 src/MainSubjectInterface.qml
badd +28 include/SubjectInterface.h
...
badd +363 include/PerturbationTabWidget.h
...
badd +373 src/TreadmillAutomationDbIFace.cpp
...
edit src/TreadmillAutomationDbIFace.cpp
...
378
normal! zo
let s:l = 377 - ((13 * winheight(0) + 20) / 41)
