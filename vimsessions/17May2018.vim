...
badd +352 src/PerturbationTabWidget.cpp
...
badd +37 src/Channel8ScopeView.qml
badd +23 src/Channel6ScopeView.qml
badd +54 src/DataCollection.cpp
badd +285 src/MccDaqInterface.cpp
badd +116 include/MccDaqInterface.h
argglobal
silent! argdel *
$argadd src/SubjectInterface.qml
edit include/ConfigTabWidget.h
...
let s:l = 44 - ((22 * winheight(0) + 20) / 41)
