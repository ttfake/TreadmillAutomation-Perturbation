...
badd +749 src/PerturbationTabWidget.cpp
...
badd +78 include/PerturbationTabWidget.h
badd +7 src/SmileyGone.qml
badd +17 src/MouseInterface.cpp
badd +25 src/SubjectInterface.qml_bkup
badd +102 src/ParseRunProfile.cpp
badd +515 src/TreadmillAutomationDbIFace.cpp
badd +35 include/TreadmillAutomationDbIFace.h
badd +53 src/PersonSessionStimData.qml
...
let s:l = 1086 - ((0 * winheight(0) + 20) / 41)
